...
echo "INFO: Install serverinfo.sh script to /usr/local/bin/serverinfo.sh"
mv serverinfo.sh /usr/local/bin
chown root.root /usr/local/bin/serverinfo.sh
chmod +x /usr/local/bin/serverinfo.sh
